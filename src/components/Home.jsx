    ...
    >      
      ...
      >
        ...
        >
          ...
          >
            <div id="title">
              <h1 className="leading-20 poppins-semibold h-fit 2xl:h-[6rem] overflow-hidden 2xl:text-[4.5rem] lg:text-[3.5rem] md:text-[3rem] text-[2rem] flex items-center">
                <span className="inline-block">Your Partner in</span>
              </h1>
              <h1 className="leading-20 poppins-semibold h-fit 2xl:h-[6.2rem] overflow-hidden 2xl:text-[4.5rem] lg:text-[3.5rem] md:text-[3rem] text-[2rem] flex items-center">
