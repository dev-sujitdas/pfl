    ...
    <div className="w-fit p-6 rounded-2xl shadow">
      ...
      <div className="flex flex-col flex-wrap justify-between gap-4">
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 poppins-regular">Child's Current Age:</label>
          <input
            type="number"
            value={childAge}
        ...
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 poppins-regular">Age at Tertiary Education:</label>
          <input
            type="number"
            value={educationAge}
        ...
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 poppins-regular">Annual Education Cost (R):</label>
          <input
            type="number"
            value={annualCost}
        ...
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 poppins-regular">Inflation Rate (%):</label>
          <input
            type="number"
            value={inflationRate}
        ...
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 poppins-regular">Current Savings (R):</label>
          <input
            type="number"
