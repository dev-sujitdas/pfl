    ...
    <div className="w-fit lg:p-6 p-0 rounded-2xl">
      ...
      <div className="flex flex-col flex-wrap justify-between gap-4">
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 text-xs lg:text-base poppins-regular">Initial Investment (R):</label>
          <input
            type="number"
            value={initialAmount}
        ...
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 text-xs lg:text-base poppins-regular">Investment Horizon (Years):</label>
          <input
            type="number"
            value={years}
        ...
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 text-xs lg:text-base poppins-regular">Expected Return Rate (%):</label>
          <input
            type="number"
            value={returnRate}
        ...
        <div className="flex justify-between items-center gap-5">
          <label className="text-amber-50 text-xs lg:text-base poppins-regular">Risk Tolerance:</label>
          <select
            value={riskTolerance}
